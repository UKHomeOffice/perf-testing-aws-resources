...
role_name = "#{bucket_name}-bucket-readonly"

control "#{role_name}-least-privilege" do
  impact 0.7                                # The criticality, if this control fails.
  title 'Check readonly role privileges'             # A human-readable title
  desc 'Check that the readonly role associated with the bucket applies the principle of least privilege'
